namespace ControlGallery.Resources.Styles;
...
{ 
    ...
    public static Color Gray600 = Color.FromArgb("#606060");
    public static Color Gray700 = Color.FromArgb("#4a4a4a");
    public static Color Gray800 = Color.FromArgb("#353535");
    public static Color Gray900 = Color.FromArgb("#202020");
    public static Color Gray950 = Color.FromArgb("#0b0b0b");
    ...
    public static Color Cyan300Accent = Color.FromArgb("#CC0000");
